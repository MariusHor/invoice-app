...
export const InvoiceCard = ({
  ...
  return (
    <div className="mx-auto flex w-full max-w-sm justify-between overflow-hidden rounded-lg bg-white shadow-xl lg:max-w-2xl xl:max-w-4xl">
      ...
      <Link
        ...
        className="min-h-10 grid min-w-10 place-items-center border-l border-l-secondary-300 p-2 transition-all ease-in-out hover:bg-secondary-200"
      >
